...
<body>
    ...
    <form action="{{ route('tes.update', $data['idLomba']) }}" method="post" enctype="multipart/form-data">
        ...
        <input value="" type="text" id="nis" name="nis" required><br><br>

        <label for="nama_lomba">Nama Lomba:</label>
        <input value="" type="text" id="nama_lomba" name="nama_lomba" required><br><br>

        <label for="file_evidence">File Dokumentasi:</label>
        <input value="" type="file" id="file_evidence" name="file_evidence" accept="image/*,application/pdf" required><br><br>
        ...
        <input value="" type="date" id="tanggal_lomba" name="tanggal_lomba" required><br><br>
        ...
        <input value="" type="text" id="tingkat_juara_lainnya" name="tingkat_juara_lainnya" placeholder="Isi jika memilih 'Lainnya'" style="display:none;"><br><br>

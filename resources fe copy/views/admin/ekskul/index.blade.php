...
<head>
    ...
    <title>Data Kegiatan prestasi</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Kegiatan prestasi</h4>
                        <div class="card-header">
                            <h4 class="card-title">Data Kegiatan prestasi</h4>
                            <button type="button" class="btn btn-primary btn-sm float-right"
                                onclick="window.location.href='{{ route('admin.prestasi.create') }}'">
    ...
    {{-- @push('scripts') --}}
        <script>
            ...
            function editKegiatan(id) {
                ...
                window.location.href = `/admin/prestasi/${id}/edit`;
            }
        </script>
    {{-- @endpush --}}
    {{-- @endsection --}}
